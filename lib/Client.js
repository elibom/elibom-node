...
ElibomClient.prototype.listSchedules = function(schueduleId,callback){
	var options = {
		host : this.host,
		auth : this.user + ':' + this.password,
...
ElibomClient.prototype.showUsers = function(userId,callback){
	var options = {
		host : this.host,
		auth : this.user + ':' + this.password,
		path : '/users',
